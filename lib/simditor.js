...
(function(root, factory) {
  ...
  Clipboard = (function(superClass) {
    ...
    Clipboard.prototype._processPasteContent = function(pasteContent) {
      var $blockEl, $img, blob, children, insertPosition, k, l, lastLine, len, len1, len2, len3, len4, line, lines, m,
        node, o, q, ref, ref1, ref2, uploadOpt;
  ...
  ImageButton = (function(superClass) {
        ...
        return function(e, file, result) {
          ...
          if (typeof result !== 'object') {
            try {
              ...
              _this.createImage(file, result);
              file.loading(false);
              file.components.message.success(file.successText);
            } catch (_error) {
              e = _error;
              result = {
                success: false
      ...
      return this.editor.uploader.on('uploaderror', (function(_this) {
        return function(e, file, xhr) {
          ...
          if (xhr.responseText) {
            ...
            file.components.message.error(file.errorText || result.message);
            file.loading(false);
          }
        };
      })(this));
    ...
    ImageButton.prototype.createImage = function(file, result) {
      var name = file.name;
      if (name == null) {
        name = 'Image';
      }
      ...
      $img = $('<img/>').attr('src', file.host + result.url);
  ...
  TableButton = (function(superClass) {
    ...
    TableButton.prototype.initResize = function($table) {
      ...
      return $wrapper.on('mousedown', '.simditor-resize-handle', function(e) {
        var $handle, $leftCol, $leftTd, $rightCol, $rightTd, minWidth, startHandleLeft, startLeftWidth, startRightWidth,
          startX, tableWidth;
